...
object TranslationCatalog {
    val all = listOf(
        ...
        TranslationMeta("yusufali", "Yusuf Ali", TranslationLanguage.ENGLISH, isBundled = false, downloadUrl = "https://example.com/translations/en/yusufali.db"),
        ...
        TranslationMeta("arberry", "Arberry", TranslationLanguage.ENGLISH, isBundled = false, downloadUrl = "https://example.com/translations/en/arberry.db"),
        TranslationMeta("bayan", "Al-Bayan", TranslationLanguage.BENGALI, isBundled = true, downloadUrl = null),
        TranslationMeta("taisirul", "Taisirul Quran", TranslationLanguage.BENGALI, isBundled = false, downloadUrl = "https://example.com/translations/bn/taisirul.db"),
